...
public class QRUtils {
	...
	/**
	 * Returns a 150x150px encoded QR Code in the form of an Image. 
	...
	/**
	 * Returns an encoded QR Code in the form of an Image. The
	 ...
	 * @see         Image
	 */
	public static Image generateQRCode(String data, Dimension size) {
